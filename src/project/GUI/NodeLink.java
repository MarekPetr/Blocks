...
public class NodeLink extends AnchorPane {
    ...
    private void initialize() {
        ...
        mControlDirectionX1.bind(new When(node_link.startXProperty().greaterThan(node_link.endXProperty())).then(-1.0).otherwise(1.0));
        mControlDirectionX2.bind(new When (node_link.startXProperty().greaterThan(node_link.endXProperty())).then(1.0).otherwise(-1.0));
    ...
    public void setStart(Point2D start) {
        node_link.setStartX(start.getX());
        node_link.setStartY(start.getY());
    }

    public void setEnd(Point2D end) {
        node_link.setEndX(end.getX());
        node_link.setEndY(end.getY());
    }
